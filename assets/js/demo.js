var DEMO = {
	...
	initialize: function initialize(inIdCanvas, inParameters) {
        ...
        var directionalLight = new THREE.DirectionalLight(0xffffa5, 1);
		directionalLight.position.set(-600, 300, 600);
		this.ms_Scene.add(directionalLight);

        this.ms_Scene.add(new THREE.AmbientLight( 0x404040 ));
         //
        // this.ms_Scene.add(new THREE.HemisphereLight(0x443333, 0x111122));
	...
	loadTerrain: function loadTerrain(inParameters) {
        ...
        terrain.position.z = 5000;
        terrain.position.x = 5000;
