...
var mqtt = require('mqtt');
 const mqttClient  = mqtt.connect('mqtt://mqtt-pwc.cognitedata.com');
...
function sendDataToAPI() {
 ...
 mqttClient.publish('pwc-windmill-sensors', JSON.stringify({ rpm: dataTurbine.rpm, torque: dataTurbine.torque, wind: dataTurbine.wind, time: now }));
